...
public final class SpecificCountryQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("country", arguments: ["code": "DE"], type: .object(Country.selections)),
      ]
    }
    ...
    public struct Country: GraphQLSelectionSet {
      ...
      public init(name: String, native: String, capital: String? = nil, currency: String? = nil, emoji: String, states: [State]) {
        self.init(unsafeResultMap: ["__typename": "Country", "name": name, "native": native, "capital": capital, "currency": currency, "emoji": emoji, "states": states.map { (value: State) -> ResultMap in value.resultMap }])
      }
